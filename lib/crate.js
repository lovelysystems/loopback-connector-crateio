...
exports.initialize = function initializeDataSource(dataSource, callback) {
  ...
  var res = crate.connect('localhost', 4200);
 ...
 * @param {Function} [callback] The callback function
 */
Crate.prototype.updateOrCreate = Crate.prototype.save = function (model, data, callback) {
  var mysql = this;
  var fieldsNames = [];
  var fieldValues = [];
  var combined = [];
...
Crate.prototype.singleIndexSettingsSQL = function (model, prop) {
...
Crate.prototype.indexSettingsSQL = function (model, prop) {
